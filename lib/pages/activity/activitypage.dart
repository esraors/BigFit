...
import 'package:big_fit_vize/pages/activity/activitypageanimation.dart';
...
class _ActivityPageState extends State<ActivityPage>
  ...
  _getActivityList(Size size, TextTheme textTheme) => Transform(
      ...
      child: Padding(
        ...
        child: ListView(
          children: <Widget>[
            _getListItem(textTheme, 'yürüyüş', Icons.directions_walk),
            _getListItem(textTheme, 'koşu', Icons.directions_run),
            _getListItem(textTheme, 'Bisiklet', Icons.motorcycle),
          ],
        ),
      ));
